...
[DataContract]
[Serializable]
public class PartnerInventoryItemCommand : CompanyEntityCommand
{
    /// <summary>
    ...
    /// <inheritdoc/>
    protected override string DefaultAggregateName() => InventoryHelper.PartnerInventoryItemAggregateName;
}