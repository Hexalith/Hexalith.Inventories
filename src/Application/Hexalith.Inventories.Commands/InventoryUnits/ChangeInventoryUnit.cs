...
// ***********************************************************************
// <copyright file="ChangeInventoryUnit.cs" company="Fiveforty SAS Paris France">
...
[DataContract]
[Serializable]
public class ChangeInventoryUnit : InventoryUnitCommand
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ChangeInventoryUnit" /> class.
    /// </summary>
    ...
    public ChangeInventoryUnit() => Name = string.Empty;
