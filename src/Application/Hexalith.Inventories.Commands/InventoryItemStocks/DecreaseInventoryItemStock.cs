...
// ***********************************************************************
// <copyright file="DecreaseInventoryItemStock.cs" company="Fiveforty SAS Paris France">
...
[DataContract]
[Serializable]
public class DecreaseInventoryItemStock : InventoryItemStockCommand
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DecreaseInventoryItemStock"/> class.
    /// </summary>
    ...
    public DecreaseInventoryItemStock(
        string partitionId,
        string companyId,
        string originId,
        string locationId,
