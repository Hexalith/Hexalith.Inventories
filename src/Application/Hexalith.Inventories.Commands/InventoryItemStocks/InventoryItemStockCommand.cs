...
[DataContract]
[Serializable]
public class InventoryItemStockCommand : CompanyEntityCommand
{
    /// <summary>
    ...
    /// <inheritdoc/>
    protected override string DefaultAggregateId() => InventoryHelper.GetInventoryItemStockAggregateId(PartitionId, CompanyId, OriginId, LocationId, Id);
