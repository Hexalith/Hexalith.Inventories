...
// ***********************************************************************
// <copyright file="AddInventoryUnitConversion.cs" company="Fiveforty SAS Paris France">
...
/// <summary>
/// Class AddInventoryItemConversion.
/// Implements the <see cref="InventoryUnitConversionCommand" />.
/// </summary>
/// <seealso cref="InventoryUnitConversionCommand" />
[DataContract]
[Serializable]
public class AddInventoryUnitConversion : InventoryUnitConversionCommand
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddInventoryUnitConversion" /> class.
    /// </summary>
    ...
    public AddInventoryUnitConversion(
        string partitionId,
        string companyId,
        string originId,
        string id,
