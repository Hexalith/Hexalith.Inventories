...
// ***********************************************************************
// <copyright file="InventoryUnitConversionEvent.cs" company="Fiveforty SAS Paris France">
...
public abstract class InventoryUnitConversionEvent : CompanyEntityEvent
{
    ...
    /// <inheritdoc/>
    protected override string DefaultAggregateName() => InventoryHelper.InventoryUnitConversionAggregateName;
}